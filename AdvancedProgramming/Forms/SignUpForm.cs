...
namespace AdvancedProgramming
{
    public class SignUpForm : Form
    {
        ...
        private void InitializeSignUpComponents()
        {
            ...
            userNameTextBox = new TextBox { Location = new Point(140, 28), Size = new Size(200, 20) };
            ...
            passwordButtonToggle = new Button { Text = "👁", Location = new Point(305, 66), Size = new Size(30, 23), FlatStyle = FlatStyle.Flat };
            passwordButtonToggle.Click += TogglePasswordVisibility;

            var confirmLabel = new Label { Text = "Confirm:", Location = new Point(30, 110), Size = new Size(100, 20) };
            confirmPasswordTextBox = new TextBox { Location = new Point(140, 108), Size = new Size(160, 20), PasswordChar = '*' };
            confirmPasswordButtonToggle = new Button { Text = "👁", Location = new Point(305, 106), Size = new Size(30, 23), FlatStyle = FlatStyle.Flat };
            confirmPasswordButtonToggle.Click += confirmPasswordVisibilityTaggel;

            signUpButton = new Button { Text = "Sign Up", Location = new Point(140, 160), Size = new Size(100, 30) };
            signUpButton.Click += signUpButton_Click;

            messageLabel = new Label { Location = new Point(30, 210), Size = new Size(320, 60), ForeColor = Color.Red };
